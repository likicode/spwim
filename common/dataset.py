...
class DatasetFactory(object):
    ...
    def get_dataset(dataset_name, word_vectors_dir, word_vectors_file, batch_size, device, castor_dir="./", utils_trecqa="utils/trec_eval-9.0.5/trec_eval"):
        if dataset_name == 'sick':
            ...
            dataset_root = os.path.join(os.pardir, 'data', 'SemEval-PIT2015/')
            ...
            dataset_root = os.path.join(os.pardir, 'data', 'snli_1.0/')
            ...
            dataset_root = os.path.join(os.pardir, 'data', 'STS-2014')
            ...
            dataset_root = os.path.join(os.pardir, 'data', 'quora/')
            ...
            dataset_root = os.path.join(os.pardir, 'data', 'Twitter-URL/')
            train_loader, dev_loader, test_loader = Twitter.iters(dataset_root, word_vectors_file, word_vectors_dir, batch_size, device=device, unk_init=UnknownWordVecCache.unk)
            embedding = nn.Embedding.from_pretrained(Twitter.TEXT_FIELD.vocab.vectors)
