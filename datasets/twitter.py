...
class Twitter(CastorPairDataset):
    NAME = 'Twitter'
    NUM_CLASSES = 2
    ...
    def __init__(self, path):
        ...
        """
        super(Twitter, self).__init__(path)

    @classmethod
    def splits(cls, path, train='train', validation='dev', test='test', **kwargs):
        return super(Twitter, cls).splits(path, train=train, validation=validation, test=test, **kwargs)
